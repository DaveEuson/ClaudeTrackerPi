...
sed -e "s/@VERSION@/$VERSION/" -e "s/@DATE@/$(date -u +%Y-%m-%d)/" \
    ...
    > "$ROOT/usr/share/metainfo/io.github.daveeuson.YoyuCompanion.metainfo.xml"
chmod 0644 "$ROOT/usr/share/metainfo/io.github.daveeuson.YoyuCompanion.metainfo.xml"
